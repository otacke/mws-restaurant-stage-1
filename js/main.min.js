var restaurants,neighborhoods,cuisines,map,markers=[];fetchNeighborhoods=function(){DBHelper.fetchNeighborhoods(function(a,c){a?console.error(a):(self.neighborhoods=c,fillNeighborhoodsHTML())})};fillNeighborhoodsHTML=function(a){a=void 0===a?self.neighborhoods:a;var c=document.getElementById("neighborhoods-select");a.forEach(function(a){var b=document.createElement("option");b.innerHTML=a;b.value=a;c.append(b)})};
fetchCuisines=function(){DBHelper.fetchCuisines(function(a,c){a?console.error(a):(self.cuisines=c,fillCuisinesHTML())})};fillCuisinesHTML=function(a){a=void 0===a?self.cuisines:a;var c=document.getElementById("cuisines-select");a.forEach(function(a){var b=document.createElement("option");b.innerHTML=a;b.value=a;c.append(b)})};
window.initMap=function(){self.map=new google.maps.Map(document.getElementById("map"),{zoom:12,center:{lat:40.722216,lng:-73.987501},scrollwheel:!1});fetchNeighborhoods();fetchCuisines();updateRestaurants()};updateRestaurants=function(){var a=document.getElementById("cuisines-select"),c=document.getElementById("neighborhoods-select");DBHelper.fetchRestaurantByCuisineAndNeighborhood(a[a.selectedIndex].value,c[c.selectedIndex].value,function(a,c){a?console.error(a):(resetRestaurants(c),fillRestaurantsHTML())})};
...
addMarkersToMap=function(a){a=void 0===a?self.restaurants:a;a.forEach(function(a){var b=DBHelper.mapMarkerForRestaurant(a,self.map);google.maps.event.addListener(b,"click",function(){window.location.href=b.url});self.markers.push(b)})};navigator.serviceWorker&&navigator.serviceWorker.register("/sw.min.js").then(function(){return console.log("Service worker has been registered.")})["catch"](function(a){return console.log("Could not register service worker ("+a+").")});
