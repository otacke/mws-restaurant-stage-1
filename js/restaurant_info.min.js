...
getParameterByName=function(b,e){e||(e=window.location.href);b=b.replace(/[\[\]]/g,"\\$&");var a=(new RegExp("[?&]"+b+"(=([^&#]*)|&|#|$)")).exec(e);return a?a[2]?decodeURIComponent(a[2].replace(/\+/g," ")):"":null};navigator.serviceWorker&&navigator.serviceWorker.register("/sw.js").then(function(){return console.log("Service worker has been registered.")})["catch"](function(b){return console.log("Could not register service worker ("+b+").")});
